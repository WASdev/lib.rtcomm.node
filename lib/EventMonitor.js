...
* 
* config.eventPath
* config.category  ['session'|'registration']
* config.type ['start'|'stopped'|'modified']  -- could be an Array?
* config.endpointid = [toendpointid, fromendpointid]
*
* 
*/
...
function EventMonitor(config) {
  ...
  /**
   * addFilter - Initialize the EventMonitor
   * @param {Object} filter - pass any of these as object: filter.category, filter.type, filter.toendpointid, filter.fromendpointid, filter.endpointid
